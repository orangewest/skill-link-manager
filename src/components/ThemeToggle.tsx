  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        title={t("theme")}
        className="flex items-center justify-center rounded-lg border border-gray-300 px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
      >
        <CurrentIcon />
      </button>
      {open && (
